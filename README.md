...
*  The app sometimes shows an error or runs slowly as it has to reload from scratch. This is because Streamlit has strict resource limits so the caching limit is set to 3600 minutes and maximum of 10 functions rather than persisting.
